...
const Explore = () => {
  ...
  const { data: searchedPosts, isPending: isSearchFetching } = useSearchPost(debouncedValue);
    ...
    <div className="explore-container">
      <div className="explore-inner_container">
        ...
        <div className="flex gap-1 px-4 w-full rounded-lg bg-dark-4">
          ...
          <Input type="text" className="explore-search" placeholder="Search" value={searchValue} onChange={(e) => setSearchValue(e.target.value)}/>
        </div>
